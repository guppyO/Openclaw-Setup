# Experiment: Automation packs sold through compliant marketplaces

## Thesis

Package two internal workflow assets into a starter bundle and A/B test listings across one primary marketplace and one owned landing page.
...
- Kill: Kill if no meaningful traction signal appears before 60% of budget cap is consumed.
- Compound: Compound if initial payback is visible and distribution can be expanded without sharply raising CAC.
